...
class Resourceperson
{
     ...
     * @return Resourceperson
     */
    public function addSession(\ABC\ResourcePersonBundle\Entity\Session $session)
    {
     ...
     * @param \ABC\ResourcePersonBundle\Entity\Session $session
     */
    public function removeSession(\ABC\ResourcePersonBundle\Entity\Session $session)
    {
